  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="w-[92%] max-w-sm rounded-2xl bg-white p-6 md:p-8 text-ink-main shadow-2xl animate-fade-up"
            onClick={(e) => e.stopPropagation()}
          >
            <h2 className="font-cn text-lg md:text-xl">解锁编辑权限</h2>
            <p className="mt-1 mb-5 text-sm text-ink-muted">输入共享密码即可开始编辑。</p>
            <input
              type="password"
              autoFocus
              value={input}
